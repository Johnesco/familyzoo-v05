# Family Zoo — v05 — Containers & Supporters — Claude Project Memory
...
**Name:** Family Zoo — v05 — Containers & Supporters
**Purpose:** Sharpee tutorial step 5 — Containers & Supporters.
...
**Repository:** https://github.com/Johnesco/familyzoo-v05
**Live:** https://johnesco.github.io/familyzoo-v05/
...
├── familyzoo-05.js         the built story bundle
...
The steps are **generated**, not hand-edited: each one is `familyzoo.story` sliced to the blocks introduced at or before this step, with per-step room prose so a description never names a thing the step has not created yet. Change the master and the step map, then re-lay the steps — do not hand-edit `familyzoo-v05.story`.
